...
export const ExperienceCard : React.FC<CardType> = ({index}) => {
  return (
    <div className={`flex justify-between items-start w-full w-min-[900px] gap-x-[50px] ${index%2==0?"flex-row-reverse":"flex-row"}`}>
        ...
        <div className="pt-1">
            <h4 className="text-[36px] font-semibold leading-[46px]">FULL STACK DEVELOPER</h4>
            ...
            <p className="my-[15px] font-sans max-w-[400px] text-[14px] leading-[18px]">
...
export const ProjectCard : React.FC<CardType> = ({index}) => {
    return (
      <div className={`flex justify-between items-start w-full w-min-[900px] gap-x-[50px] ${index%2==0?"flex-row-reverse":"flex-row"}`}>
          ...
          <div className="pt-1">
              <h4 className="text-[36px] font-semibold leading-[46px]">DRIVE CONNECT</h4>
