const GoSVG = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg"  width="50px" height="50px" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 254.5 225" xmlSpace="preserve">
{/* <style type="text/css">
	.st0{fill:#2DBCAF;}
	.st1{fill:#5DC9E1;}
	.st2{fill:#FDDD00;}
    ...
    <g className="-translate-x-10 -translate-y-8 scale-125">
        <g>
            <g>
                <g>
